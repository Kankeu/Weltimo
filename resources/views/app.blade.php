...
<div id="main" style="overflow-x: hidden">
    <div style="z-index: -1;position: absolute;height: 100%;width: 100%;top: 0;left:0;right: 0;bottom: 0;background: white;display: flex;justify-content: center;align-items: center;flex-direction: column">
...
<script src="{{ mix('/js/vendorApp.js') }}"></script>
