<template>
    <md-table v-model="searched" md-sort="name" md-sort-order="asc" md-card md-fixed-header>
      ...
      <md-table-row slot="md-table-row" slot-scope="{ item }">
        <md-table-cell md-label="state" md-sort-by="id" md-numeric><md-icon>check</md-icon></md-table-cell>
        <md-table-cell md-label="ID" md-sort-by="id" md-numeric>{{ item.id }}</md-table-cell>
        <md-table-cell md-label="Name" md-sort-by="name">{{ item.name }}</md-table-cell>
        <md-table-cell md-label="Email" md-sort-by="email">{{ item.email }}</md-table-cell>
        <md-table-cell md-label="Message" md-sort-by="gender">{{ item.gender }}</md-table-cell>
        <md-table-cell md-label="Date" d-sort-by="title">{{ item.title }}</md-table-cell>
      </md-table-row>
    </md-table>
</template>
