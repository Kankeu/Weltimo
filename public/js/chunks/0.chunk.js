...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__card_Card_vue__ = __webpack_require__(293);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__card_CardPublication_vue__ = __webpack_require__(296);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    components: { card: __WEBPACK_IMPORTED_MODULE_0__card_Card_vue___default.a, cardPublication: __WEBPACK_IMPORTED_MODULE_1__card_CardPublication_vue___default.a },
    data: function data() {
        return {};
    },
    computed: {
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-36e2bf48", Component.options)
  } else {
    hotAPI.reload("data-v-36e2bf48", Component.options)
' + '  }
    ...
    [
      _c(
        ...
        [
          ...
          _c("v-card-media", {
            attrs: {
              height: "400px",
              src: "/img/articles/" + _vm.article.n + ".jpg"
            }
          }),
          _vm._v(" "),
            ...
            [
              ...
              _c(
                "v-btn",
                {
                  ...
                  nativeOn: {
                    click: function($event) {
                      _vm.article.show = !_vm.article.show
                    }
                  }
                },
                [
      ...
      _c(
        "v-menu",
        {
          ...
          model: {
            value: _vm.article.popover,
            callback: function($$v) {
              _vm.$set(_vm.article, "popover", $$v)
            },
            expression: "article.popover"
          }
        },
        [
          _c(
                      ...
                      _c(
                        ...
                        [
                          _c(
                            "v-btn",
                            {
                              class: _vm.article.fav ? "blue--text" : "",
                              attrs: { icon: "" },
                              nativeOn: {
                                click: function($event) {
                                  _vm.article.fav = !_vm.article.fav
                                }
                              }
                            },
      ...
      _c(
        ...
        {
          model: {
            value: _vm.article.menu,
            callback: function($$v) {
              _vm.$set(_vm.article, "menu", $$v)
            },
            ...
            [
              _c(
                ...
                [
                  _c(
                    "v-list-tile-title",
                    [_c("v-icon", [_vm._v("share")]), _vm._v(" Partager")],
                    1
                  )
                ],
                1
              ...
              _c(
                ...
                [
                  _c(
                    "v-list-tile-title",
                    [_c("v-icon", [_vm._v("trash")]), _vm._v(" Delete")],
                    1
                  )
                ],
                1
              ...
              _c(
                ...
                [
                  _c(
                    "v-list-tile-title",
                    [_c("v-icon", [_vm._v("info")]), _vm._v(" Signaler")],
                    1
                  )
                ],
                1
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-36e2bf48", module.exports)
  }
}
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(11)("09382a33", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        openSwatches: function openSwatches(el) {
            var _this = this;

            __webpack_require__.e/* import() */(14).then(__webpack_require__.bind(null, 303)).then(function (_ref) {
                ...
                if (el === "#picker1") {
                    ...
                    _this.box1 = textarea.parentNode;
                } else {
                    el = el + " .emojionearea-editor";
                    var _textarea = document.querySelector(el);
                    _this.box2 = _textarea.parentNode;
                }
            });
        },
        ...
        publish: function publish(el) {
            ...
            var text = this.replaceImg(el);
            var color = el === "#picker1" ? this.color1 : this.color2;
        ...
        replaceImg: function replaceImg(el) {
            el = el + " textarea";
            var html = document.querySelector(el).value;
    ...
    watch: {
        color1: function color1(data) {
            if (data.hex) {
                var textarea = this.box1.querySelector('.emojionearea-editor');
                if (data.hex !== "#FFFFFF") {
        ...
        color2: function color2(data) {
            if (data.hex) {
                var textarea = this.box2.querySelector('.emojionearea-editor');
                if (data.hex !== "#FFFFFF") {
                    textarea.style.color = "#FFFFFF";
                } else {
                    textarea.style.color = "black";
              ...
              _c(
                ...
                [
                  _c("v-card-text", [
                    _c(
                      "div",
                      { attrs: { id: "picker1" }, on: { click: _vm.enlarge } },
                  ...
                  _c(
                    ...
                    [
                      ...
                      _vm.url
                        ? _c(
                            "v-avatar",
                            { attrs: { size: "400px", tile: true } },
                            [
                              _c("img", {
                                attrs: { src: _vm.url, alt: "image" }
                              })
                            ]
                          )
                        : _vm._e()
