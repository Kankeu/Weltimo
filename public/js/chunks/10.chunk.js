...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__box_Requests_vue__ = __webpack_require__(352);
//
//
//
//
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Request_vue__ = __webpack_require__(353);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__DialogMessage_vue__ = __webpack_require__(355);
//
//
//
//
    ...
    methods: {
                ...
                if (!this.end && this.ready) {
                    ...
                    this.$http.get(this.query.next).then(function (response) {
                        if (Array.isArray(response.body.data)) {
                            var users = [];
                            response.body.data.map(function (boxmessage) {
        ...
        load: function load() {
            ...
            if (!this.query && this.ready) {
                this.ready = false;
                this.$store.dispatch('setting/setLoading', true);
                var url = this.user.role === "admin" ? '/admin/request' : '/user/request';
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__DiscussionState_vue__ = __webpack_require__(358);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__MessageBox_vue__ = __webpack_require__(362);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__State__ = __webpack_require__(376);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["a"] = ({
    ...
    mounted: function mounted() {
        ...
        this.$http.get('/user/request/' + this.boxmessage.id + '/discussionstate').then(function (response) {
            if (response.body.id) {
                ...
                _this4.msgAlert = _this4.discussionstate.state !== _this4.discussionstate.confirmated && _this4.user.id !== _this4.discussionstate.user_id;
                _this4.step = _this4.discussionstate.confirmated;
            }
            _this4.step = 1;
        });
    },
    ...
    watch: {
        discussionstate: function discussionstate(data) {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Message_vue__ = __webpack_require__(365);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__MessageBoxForm_vue__ = __webpack_require__(369);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__DialogFormEdit_vue__ = __webpack_require__(373);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["a"] = ({
    ...
    watch: {
        messages: function messages(data, lastData) {
            if (data.length > lastData.length) {
                var elt = this.$el.querySelector('.chat');
...
/* harmony default export */ __webpack_exports__["a"] = ({
    ...
    methods: {
        save: function save() {
            ...
            this.$http.put('/user/request/' + this.boxmessage.id, { offer: this.select.join(', ') }).then(function (response) {
                if (response.body.id) {
                    _this.snackbar = true;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_729be736_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Requests_vue__ = __webpack_require__(378);
...
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_5683b704_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Request_vue__ = __webpack_require__(354);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__ = __webpack_require__(3);
var disposed = false
/* script */
      ...
      _c(
        ...
        [
          _c(
            ...
            [_c("img", { attrs: { src: _vm.owner.avatar, alt: "boxmessage" } })]
          ),
          _vm._v(" "),
          _c(
            "v-list-tile-content",
...
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_454bf364_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_DialogMessage_vue__ = __webpack_require__(377);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__ = __webpack_require__(3);
var disposed = false
...
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_ce001990_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_DiscussionState_vue__ = __webpack_require__(361);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__ = __webpack_require__(3);
var disposed = false
function injectStyle (context) {
  if (disposed) return
          ...
          _c(
            ...
            [
              _c("v-card", {
                ...
                attrs: { height: _vm.msgAlert ? "100px" : "150px" }
              }),
              _vm._v(" "),
              _vm.discussionstate.confirmated === _vm.discussionstate.state ||
              _vm.discussionstate.user_id !== _vm.user.id
...
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_5a227ab6_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_MessageBox_vue__ = __webpack_require__(375);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__ = __webpack_require__(3);
var disposed = false
function injectStyle (context) {
  if (disposed) return
...
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_5c26b5f6_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Message_vue__ = __webpack_require__(368);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__ = __webpack_require__(3);
var disposed = false
function injectStyle (context) {
  if (disposed) return
...
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_ade739ee_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_MessageBoxForm_vue__ = __webpack_require__(372);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__ = __webpack_require__(3);
var disposed = false
function injectStyle (context) {
  if (disposed) return
...
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_0a4faf37_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_DialogFormEdit_vue__ = __webpack_require__(374);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__ = __webpack_require__(3);
var disposed = false
/* script */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_27f88afe_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Box_vue__ = __webpack_require__(379);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__ = __webpack_require__(3);
var disposed = false
function injectStyle (context) {
  if (disposed) return
