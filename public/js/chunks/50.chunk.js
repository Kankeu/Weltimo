...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__profile_XsHeader_vue__ = __webpack_require__(286);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__profile_Header_vue__ = __webpack_require__(292);
//
//
//
//
            ...
            if (this.profile.followed) {
                this.$http.get("user/unfollow/" + this.profile.id).then(function (response) {
                    if (response.body.status === 1) {
                        ...
                        _this2.$set(profile, 'followed', null);
                        profile.followers_count--;
                        _this2.text = _this2.profile.forename + ' is no longer followed by you!';
                        _this2.text = 'You follow no longer ' + _this2.profile.forename + '!';
                ...
                this.$http.post('user/subscription', { receiver_id: this.profile.id }).then(function (response) {
                    if (response.body.id) {
                        ...
                        _this2.loadingSubs = false;
                        profile.followers_count++;
                        _this2.text = 'You follow ' + _this2.profile.forename + '!';
                        _this2.snackbar = true;
                    }
                });
            }
        ...
        send: function send(name) {
            ...
            this.$http.post('user/' + name, formdata).then(function (response) {
                if (response.body.status === 1) {
                    ...
                    _this3.$store.dispatch('user/update', data);
                    _this3.$store.dispatch('users/update', _this3.user);
                    _this3.text = _this3.urls.avatar ? 'Avatar had been updated!' : 'Cover picture had been updated!';
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_cd867b2a_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_XsHeader_vue__ = __webpack_require__(291);
...
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_783fb3d0_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Header_vue__ = __webpack_require__(297);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__ = __webpack_require__(3);
var disposed = false
function injectStyle (context) {
  if (disposed) return
        ...
        [
          _c(
            "v-parallax",
            {
              ...
              attrs: {
                src:
                  _vm.urls.cover && _vm.user.id === _vm.profile.id
                    ? _vm.urls.cover
                    : _vm.profile.cover,
                jumbotron: "",
                height: "300"
          ...
          _c(
            ...
            [
              ...
              _c("img", {
                attrs: {
                  src:
                    _vm.urls.avatar && _vm.user.id === _vm.profile.id
                      ? _vm.urls.avatar
                      : _vm.profile.avatar,
                  alt: "avatar"
                }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_503e1b48_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Profile_vue__ = __webpack_require__(298);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__ = __webpack_require__(3);
var disposed = false
function injectStyle (context) {
  if (disposed) return
