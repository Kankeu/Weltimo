...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__comment_ArticleBox_vue__ = __webpack_require__(107);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__comment_CommentBox_vue__ = __webpack_require__(111);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__comment_state__ = __webpack_require__(88);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["a"] = ({
    components: { articleBox: __WEBPACK_IMPORTED_MODULE_0__comment_ArticleBox_vue__["a" /* default */], commentBox: __WEBPACK_IMPORTED_MODULE_1__comment_CommentBox_vue__["a" /* default */] },
    data: function data() {
        return {
            openDialogComment: false,
            store: __WEBPACK_IMPORTED_MODULE_2__comment_state__["a" /* default */].state
        };
    },
    computed: {
        ...
        article: function article() {
            ...
            return this.$store.state.article.articles.find(function (article) {
                return article.id === parseInt(_this.$route.params.article);
            }) || {};
        },
        ...
        query: function query() {
            ...
            return this.$store.state.query.queries.find(function (e) {
                return e.name === "article" && e.id === parseInt(_this3.$route.params.article);
            });
        }
    },
    methods: {
        load: function load() {
            ...
            if (!this.query) {
                ...
                this.$http.get('/user/profile/' + this.$route.params.id + '/article/' + this.$route.params.article).then(function (response) {
                    if (response.body.id) {
                        _this4.$store.dispatch("article/save", response.body);
                        _this4.$store.dispatch("query/save", { name: 'article', id: parseInt(_this4.$route.params.article) });
                    }
                    _this4.openDialogComment = true;
    ...
    [
      _c(
        "v-dialog",
        {
          attrs: { width: "935px" },
          model: {
            value: _vm.openDialogComment,
            callback: function($$v) {
              _vm.openDialogComment = $$v
            },
            expression: "openDialogComment"
          }
        },
        [
          _vm.loading
          ...
          _c(
            ...
            [
              _c(
                "v-carousel-item",
                { staticClass: "carousel_item", attrs: { src: " " } },
                [
                  _c(
                    "v-card",
                    {
                      ...
                      _c(
                        ...
                        [
                          _vm.article.id
                            ? _c(
                                "v-layout",
                                { staticClass: "notSpace", attrs: { row: "" } },
                                [
                                  _c(
                                    "v-flex",
                                    {
                            ...
                            : _c(
                                ...
                                [
                                  ...
                                  _vm._v(" "),
                                  _c("h4", [
                                    _vm._v("May be is the publication delete.")
                                  ])
                                ]
                              )
                        ],
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-3d7896ee", { render: render, staticRenderFns: staticRenderFns })
  }
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_cacheDirectory_true_presets_env_modules_false_targets_browsers_2_uglify_true_env_modules_false_targets_browsers_last_2_versions_safari_7_debug_true_plugins_transform_object_rest_spread_transform_runtime_polyfill_false_helpers_false_syntax_dynamic_import_node_modules_vue_loader_lib_selector_type_script_index_0_Article_vue__ = __webpack_require__(184);
/* empty harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_3d7896ee_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Article_vue__ = __webpack_require__(290);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__ = __webpack_require__(3);
var disposed = false
/* script */
...
var Component = Object(__WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__["a" /* default */])(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_cacheDirectory_true_presets_env_modules_false_targets_browsers_2_uglify_true_env_modules_false_targets_browsers_last_2_versions_safari_7_debug_true_plugins_transform_object_rest_spread_transform_runtime_polyfill_false_helpers_false_syntax_dynamic_import_node_modules_vue_loader_lib_selector_type_script_index_0_Article_vue__["a" /* default */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_3d7896ee_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Article_vue__["a" /* render */],
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_3d7896ee_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Article_vue__["b" /* staticRenderFns */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "resources/assets/js/components/card/Article.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-3d7896ee", Component.options)
  } else {
    hotAPI.reload("data-v-3d7896ee", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
